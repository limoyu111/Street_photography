...
from ldm.modules.local_module import LocalAttentionBlock, LocalConvBlockv1, LocalConvBlockv2, LocalRefineBlock, LocalRefineBlockCondFLAG
    ...
    def forward(self, x, emb, context, local_context, **kwargs):
        ...
        for layer in self:
            if isinstance(layer, TimestepBlock):
                ...
                x = layer(x, context)
            elif isinstance(layer, (LocalAttentionBlock, LocalConvBlockv1, LocalConvBlockv2, LocalRefineBlock, LocalRefineBlockCondFLAG)):
                # bbox=None, local_context=None, indicator=None, mask=None, mask_method='sum'
                if isinstance(layer, (LocalRefineBlock, LocalRefineBlockCondFLAG)):
