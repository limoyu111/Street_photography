...
from ldm.data.pcache_access import read_pcache_txt, read_pcache_image
...
def test_mvimgnet_dataset():
    ...
    cfg_path = os.path.join(proj_dir, 'configs/finetune_mvimgnet.yaml')
    ...
    vis_dir = os.path.join(proj_dir, 'outputs/test_dataaug/mvimgnet')
