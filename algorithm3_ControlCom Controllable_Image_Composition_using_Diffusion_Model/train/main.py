...
def merge_opt_and_config(opt, config):
    if opt.train_devices != None:
        config.lightning.trainer.devices = opt.train_devices
    if opt.devices != None:
    ...
    if opt.local_key != None:
        config.model.params.unet_config.params.local_encoder_config.conditioning_key = opt.local_key
