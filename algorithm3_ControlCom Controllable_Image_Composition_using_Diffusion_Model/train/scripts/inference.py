...
from ldm.data.pcache_access import download_file_by_command, read_pcache_tensor, \
    upload_folder_by_command, upload_file_by_command
...
def main():
    ...
    parser.add_argument(
        "--ckpt",
        type=str,
        default="pretrained_models/paint-modified.ckpt",
    ...
    parser.add_argument(
        ...
        type=str,
        help="evaluate at this precision",
        default="examples/image/example_1.png"
    )
    parser.add_argument(
        "--mask_path",
        type=str,
        help="evaluate at this precision",
        default="examples/mask/example_1.png"
    )
    parser.add_argument(
        "--reference_path",
        type=str,
        help="evaluate at this precision",
        default="examples/reference/example_1.jpg"
    )
