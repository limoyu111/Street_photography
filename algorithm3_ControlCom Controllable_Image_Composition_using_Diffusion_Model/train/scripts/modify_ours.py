...
our_model_path = 'experiments/finetune_paint/indicator4/2023-07-04T14-53-03_Refine_maskedbg/checkpoints/last.ckpt'
our_ckpt = torch.load('experiments/finetune_paint/indicator4/2023-07-04T14-53-03_Refine_maskedbg/checkpoints/last.ckpt', map_location='cpu')
learnable_vector = ckpt_file['state_dict']['learnable_vector']
if 'state_dict' in our_ckpt:
    our_ckpt['state_dict']['learnable_vector'] = learnable_vector
else:
    our_ckpt['learnable_vector'] = learnable_vector
...
print('save modified model to ', our_model_path)
torch.save(our_ckpt, our_model_path)