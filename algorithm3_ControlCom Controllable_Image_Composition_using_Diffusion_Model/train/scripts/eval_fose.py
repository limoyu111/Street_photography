...
from ldm.data.open_images_control import FOSEDataset, reverse_image_tensor, reverse_mask_tensor, reverse_clip_tensor
import time
        ...
        with precision_scope("cuda"):
            with model.ema_scope():
                for index, batch in enumerate(dataloader):
                    ...
                    if os.path.exists(grid_path) and check_result_images(resdir_list, img_name, opt.n_samples):
                        continue
...
# CUDA_VISIBLE_DEVICES=2,3,4,5,6,7 torchrun --nproc_per_node=4 --master_port=29500 scripts/eval_fose.py
